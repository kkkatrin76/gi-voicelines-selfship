const db = {
    ...
    zhongrin: {
        ...
        voicelines: [{
            ...
            content: `<p>The storytellers in Liyue do not tell this one tale often, for it has been lost with time... To the adepti who knew of Rex Lapis back from his younger days, the dragon has always had a companion - one mortal woman. Ever since, it is said that the soul of that mortal has been reborn, again and again, and the contract between the two causes him to seek her out every single time. It is to this that scholars speculate why dragons mate for life, and why couples who wishes for longevity in their relationship always incorpoarates cor lapis in their wedding rings. Is it not a fascinating fairytale-like story?</p><p>Why am I telling you this? Haha...</p><p>Perhaps I regretted not trying harder to keep this certain tale passed down the generations. But as the witness of this world, I suppose I was hoping someone else would not forget that memory, even after our contract was fulfilled.</p>`,
        }, {
            title: `About Meirin: Children`,
            content: `<p>My utmost gratitude for taking the commission to babysit Liwei and Liwen the other day.</p><p>They're quite a handful, weren't they? Haha, I'd say you did your job very well. My apologies again for contacting you so abruptly, but given how my son is still unable to control his form and my daughter's prominent draconic features... The number of people we could ask for help are quite limited.</p><p>Nevertheless, I hope you had a good time with them yesterday. They seem to have taken a liking to you, in fact, and has been asking forー</p><p>.... <i>*chuckles*</i> An urgent business, you say? I see. Well then, you best be on your feet. See you around, Traveler.</p>`,
        }]
    },
}